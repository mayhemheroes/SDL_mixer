...
RUN for i in 1 2 3 4 5; do \
      ...
      DEBIAN_FRONTEND=noninteractive apt-get install -y --fix-missing \
        ...
        libogg-dev libmpg123-dev libopusfile-dev libflac-dev libxmp-dev libx11-dev && break || \
...
WORKDIR /build/SDL3
RUN cmake -S . -B build -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr/local -DSDL_WAYLAND=OFF -DSDL_OFFSCREEN=ON -DSDL_RENDER=OFF -DSDL_AUDIO=ON -DSDL_REQUIRE_VIDEO_BACKEND=OFF && \
