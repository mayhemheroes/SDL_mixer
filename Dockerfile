...
WORKDIR /build/SDL3
RUN cmake -S . -B build -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=/usr/local -DSDL_WAYLAND=OFF -DSDL_OFFSCREEN=ON -DSDL_RENDER=OFF -DSDL_AUDIO=ON && \
